class Static
{
     public static int No5;   // static characteristics
     public static int No6;
     
     static
     {
          System.out.println("Inside static block of Static class which contains main");
          No6 = 56;
          No5 = 12;
     }
     public Static()
     {
          System.out.println("Inside Constructor of Static class");
     }
     public static void main(String arg[])
     {
          ...
          System.out.println("Value of static No5 : "+Static.No5); // Demo::No3
          System.out.println("Value of static No6 : "+Static.No6);// Demo::No4
          Demo.gun();    // Demo::gun();
